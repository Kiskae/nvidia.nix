...
let
  ...
  mkPackageSet = { version, src }: lib.makeScope
    ...
    (callPackage ./packages {
      ...
      distTarball = src;
      # linuxPackages = pkgs.linuxKernel.packages.linux_5_17;
      # linuxPackages = pkgs.linuxKernel.packageAliases.linux_latest;
      linuxPackages = pkgs.linuxKernel.packages.linux_testing;
      enableCompat32 = true;
    });
